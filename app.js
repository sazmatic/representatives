...
function handleCampusChange() {
  ...
  if (campus && representatives[campus]) {
    displayCampusInfo(campus, representatives[campus]);
...
/**
 * Displays campus information and representatives.
 * @param {string} campus - Selected campus name.
 * @param {Array} reps - Array of representative objects.
 */
function displayCampusInfo(campus, reps) {
  const campusName = document.getElementById('campus-name');
  const repName = document.getElementById('rep-name');

  campusName.textContent = campus; // Set campus name
